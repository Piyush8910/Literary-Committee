...
export function HeartButton1({ text , link}) {
  ...
  return (
    <>
      ...
      <button
        onClick={handleClick}
        className={`h-14 flex items-center gap-0 ml-8 pr-9 py-2 rounded-3xl border-2 transition-colors
      ...
      >
        ...
        />
        <span className={`font-semibold text-xl transition-colors pl-3`}>
          {text}
        </span>
      </button>
    </>
